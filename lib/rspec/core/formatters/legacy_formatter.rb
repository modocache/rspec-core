    ...
    module Formatters
      ...
      class LegacyFormatter
        ...
        module LegacyInterface
          ...
          def start(count)
            super Notifications::Count.new(count)
          end

          def example_group_started(group)
            super Notifications::Group.new(group) if defined?(super)
          end
          ...
          def example_started(example)
            super Notifications::Example.new(example) if defined?(super)
          end
          ...
          def message(message)
            super Notifications::Message.new(message) if defined?(super)
          end
          ...
          def dump_summary(duration, examples, failures, pending)
            ...
            super Notifications::Summary.new(duration, examples, failures, pending) if defined?(super)
          end

          def seed(seed)
            super Notifications::Seed.new(seed, true) if defined?(super)
          end


          def start_dump
            super(Notifications::Null) if defined?(super)
          end
