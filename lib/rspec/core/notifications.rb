...
module RSpec::Core
  module Notifications
    ...
    # The `Count` represents notifications sent by the formatter
    ...
    # The `Example` represents notifications sent by the reporter
    ...
    Example = Struct.new(:example)

    # The `Group` represents notifications sent by the reporter which
    ...
    # The `Summary` holds information about the results of running
    ...
    class Summary < Struct.new(:duration, :example_count, :failure_count, :pending_count)
    ...
    # The `Deprecation` is issued by the reporter when a deprecated
    ...
    Deprecation = Struct.new(:deprecated, :message, :replacement, :call_site) do
      # @api
    ...
    # `Null` represents a placeholder value for notifications that
